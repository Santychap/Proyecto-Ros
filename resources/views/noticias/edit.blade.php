    ...
    <div class="py-6 max-w-lg mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('noticias.update', $noticia) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="titulo" id="titulo" value="{{ old('titulo', $noticia->titulo) }}" class="mt-1 block w-full border border-gray-300 rounded p-2" required>
            ...
            <div>
                ...
                <textarea name="contenido" id="contenido" rows="5" class="mt-1 block w-full border border-gray-300 rounded p-2" required>{{ old('contenido', $noticia->contenido) }}</textarea>
