            ...
            <div class="cart-layout">
                <div class="cart-section">
                    <div class="section-header">
                        ...
                        <button class="clear-cart-btn"><i class="fas fa-trash-alt"></i> Vaciar Carrito</button>
                    </div>
                ...
                <div class="summary-section">
                    <div class="order-summary">
                        ...
                        <button class="checkout-btn" {{ count($carrito) == 0 ? 'disabled' : '' }} onclick="confirmarPedido()">
    ...
    <div class="footer">
        <div class="container footer-content">
            <div class="footer-section">
                <h3>Restaurante</h3>
                <p>Ofreciendo la mejor experiencia culinaria con ingredientes frescos y un ambiente acogedor.</p>
                <div class="social-links">
                    <a href="#"><img src="https://via.placeholder.com/32/ffd700/000000?text=FB" alt="Facebook"></a>
                    <a href="#"><img src="https://via.placeholder.com/32/ffd700/000000?text=IG" alt="Instagram"></a>
                    <a href="#"><img src="https://via.placeholder.com/32/ffd700/000000?text=TW" alt="Twitter"></a>
                </div>
            </div>
            <div class="footer-section">
                <h3>Contacto</h3>
                <div class="info-item">
                    <img src="https://via.placeholder.com/28/ffd700/000000?text=L" alt="Location">
                    <p>123 Calle Principal, Ciudad, País</p>
                </div>
                <div class="info-item">
                    <img src="https://via.placeholder.com/28/ffd700/000000?text=T" alt="Phone">
                    <p>+123 456 7890</p>
                </div>
                <div class="info-item">
                    <img src="https://via.placeholder.com/28/ffd700/000000?text=E" alt="Email">
            ...
            <div class="footer-section">
                ...
                <p>Sábado - Domingo: 11:00 - 23:00</p>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-summary">
                    <h4>Total a Pagar: <span class="modal-total">${{ number_format($total, 2) }}</span></h4>
                </div>
...
function confirmarPedido() {
    if (confirm('¿Confirmar pedido?')) {
        alert('Pedido confirmado (funcionalidad pendiente)');
