...
@section('title', 'Crear Promoción - Olla y Sazón')
...
<div class="promocion-form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Agrega una nueva promoción para el restaurante</p>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('promociones.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small class="form-help">Sube una imagen para la promoción (JPG, PNG, máximo 2MB)</small>
            </div>
