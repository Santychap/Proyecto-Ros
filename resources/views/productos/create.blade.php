...
@section('title', 'Crear Producto - Olla y Sazón')
...
<div class="producto-form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Agrega un nuevo producto al menú del restaurante</p>
    </div>
        ...
        <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" class="form-input" rows="3" 
                          placeholder="Describe el producto de manera atractiva para los clientes...">{{ old('descripcion') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="ingredientes" class="form-input" rows="3" 
                          placeholder="Ej: Carne molida, frijoles, arroz, huevo frito, chicharrón, aguacate...">{{ old('ingredientes') }}</textarea>
                ...
                <div class="image-upload-container">
                    ...
                    <div class="image-preview">
                        <div class="no-image-preview" id="imagePreview">
                            ...
                            <p>Vista previa</p>
                            <p class="upload-hint">Selecciona una imagen</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    imagePreview.innerHTML = `
                        ...
                        <p class="upload-hint">Imagen seleccionada</p>
                    `;
                };
