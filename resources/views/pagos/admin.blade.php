    ...
    @if($pagos->count() > 0)
        ...
        <div class="chart-container" style="margin-bottom: 30px;">
            <form method="GET" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: end;">
                ...
                <div>
                    <label style="display: block; color: #ffd700; font-weight: 600; margin-bottom: 5px; font-size: 0.9rem;">Fecha</label>
                    <input type="date" name="fecha" value="{{ request('fecha') }}" style="background: #181828; color: #ffd700; border: 1px solid #ffd700; padding: 8px 12px; border-radius: 6px; font-size: 0.9rem;">
                </div>
                <div>
                    <label style="display: block; color: #ffd700; font-weight: 600; margin-bottom: 5px; font-size: 0.9rem;">Cliente</label>
                    <input type="text" name="cliente" value="{{ request('cliente') }}" placeholder="Nombre del cliente" style="background: #181828; color: #ffd700; border: 1px solid #ffd700; padding: 8px 12px; border-radius: 6px; font-size: 0.9rem; width: 200px;">
                </div>
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-filter"></i>Filtrar
                </button>
                <a href="{{ route('pagos.admin') }}" class="btn" style="background: #666; color: #fff;">
