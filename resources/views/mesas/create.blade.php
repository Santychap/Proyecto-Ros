...
@section('title', 'Crear Mesa - Olla y Sazón')
...
<div class="mesa-form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Agrega una nueva mesa al restaurante</p>
    </div>
        ...
        <form action="{{ route('mesas.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" class="form-input" rows="3" 
                          placeholder="Ej: Mesa junto a la ventana, vista al jardín, mesa VIP...">{{ old('descripcion') }}</textarea>
