        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8 bg-white p-6 rounded shadow">
            ...
            <form method="POST" action="{{ route('horarios.update', $horario) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="dia" id="dia" value="{{ old('dia', $horario->dia) }}" class="border-gray-300 rounded w-full" placeholder="Ejemplo: lunes, martes...">
                </div>

                <div class="mb-4">
                    <label for="hora_entrada" class="block font-medium text-sm text-gray-700">Hora Entrada</label>
                    <input type="time" name="hora_entrada" id="hora_entrada" value="{{ old('hora_entrada', $horario->hora_entrada) }}" class="border-gray-300 rounded w-full">
                </div>

                <div class="mb-4">
                    <label for="hora_salida" class="block font-medium text-sm text-gray-700">Hora Salida</label>
                    <input type="time" name="hora_salida" id="hora_salida" value="{{ old('hora_salida', $horario->hora_salida) }}" class="border-gray-300 rounded w-full">
                </div>
